...
const UnveriedPage = () => {
  ...
  return (
    <div className="absolute bottom-0 top-0 z-50 flex w-screen flex-col items-center justify-center bg-white px-4">
      ...
      <div className="mt-2 flex flex-col gap-4">
        <button
          onClick={() => logout()}
          className="btn btn-sm flex w-full flex-row gap-2 "
        >
